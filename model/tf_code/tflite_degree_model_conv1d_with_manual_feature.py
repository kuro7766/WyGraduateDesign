...
# __next = layers.Conv1D(filters=200, kernel_size=5, padding='same', activation=act)(__next)
# # __next = layers.MaxPool1D(pool_size=2)(__next)
# __next = layers.Conv1D(filters=12, kernel_size=4, padding='same', activation=act)(__next)
# # __next = layers.MaxPool1D(pool_size=5)(__next)
# __next = layers.Conv1D(filters=28, kernel_size=3, padding='same', activation=act)(__next)
# __next = layers.MaxPool1D(pool_size=3)(__next)
...
# __next = layers.Dense(500, activation=act)(__next)
__next = layers.Dense(200, activation=act)(__next)
__next = layers.Dense(40, activation=act)(__next)
__next = layers.Dense(4, activation=act)(__next)
__next = layers.Concatenate()([__next,
                               max_h_x, max_h
                               ])
__next = layers.Dense(4, activation=act)(__next)
