...
class WineListComponent extends StatefulWidget {
  @override
  _WineListComponentState createState() => _WineListComponentState();
}

class _WineListComponentState extends State<WineListComponent> {
  final logic = Get.put(WineListLogic());
  final state = Get.find<WineListLogic>().state;
  ...
  Widget build(BuildContext context) {
    return SimpleFutureBuilder(
      ...
      builder: (datas) {
        ...
        return CategoryBindScrollComponent(categories: [
